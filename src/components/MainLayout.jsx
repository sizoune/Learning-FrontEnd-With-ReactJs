  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-24">
        <Outlet />
        <div className="fixed z-40 w-full h-16 max-w-md -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
